...
using System.Data;
using AppSenhaJL_LH.Models.Constats;
    ...
    public class ClienteRepository : IClienteRepository
    {
        ...
        public void Atualizar(Cliente cliente)
        {
            ...
            using (var conexao = new MySqlConnection(_conexaoMySQL))
            {
                ...
                cmd.Parameters.Add("Email", MySqlDbType.VarChar).Value = cliente.Email; cmd.Parameters.Add("@Senha", MySqlDbType.VarChar).Value = cliente.Senha;
        ...
        public void Cadastrar(Cliente cliente)
        {
            ...
            try
            {
                using (var conexao = new MySqlConnection(_conexaoMySQL)) {
                    ...
                    cmd.Parameters.Add("@Sexo", MySqlDbType.VarChar).Value = cliente.Sexo;
                    cmd.Parameters.Add("@CPF", MySqlDbType.VarChar).Value = cliente.CPF;
                    cmd.Parameters.Add("@Telefone", MySqlDbType.VarChar).Value = cliente.Telefone; cmd.Parameters.Add("@Email", MySqlDbType.VarChar).Value = cliente.Email;
                    cmd.Parameters.Add("@Senha", MySqlDbType.VarChar).Value = cliente.Senha; cmd.Parameters.Add("@Situacao", MySqlDbType.VarChar).Value = Situacao;
                    cmd.ExecuteNonQuery();
                    conexao.Close();
                }
            }
            ...
            {
                throw new Exception("Erro no banco em cadastro do cliente" + ex.Message);
            }
            catch (Exception ex)
            {
                throw new Exception("Erro na aplicação em cadastro do cliente" + ex.Message);
            }
